...
import { deleteSingleExpense, getSingleExpense } from '../../Data/expenses';
...
const ExpenseDetails = () => {
    ...
    const handleDelete = () => {
        deleteSingleExpense(params.id, navigate, setIsloading)
        setOpen(false)
    }
    useEffect(() => {
        getSingleExpense(params.id, setData, setIsloading)
